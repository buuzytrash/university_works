...
@.str.2 = private unnamed_addr constant [7 x i8] c"True 2\00", align 1
@.str.3 = private unnamed_addr constant [6 x i8] c"After\00", align 1
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_ex.cpp, ptr null }]
