...
define dso_local i32 @main() #0 {
  ...
  %2 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0))
  %3 = call double @sum(double noundef 1.000000e+00, double noundef 2.000000e+00)
